...
export default function Contents() {
    ...
    return (
        <View className="flex-1 w-full pt-10 bg-background">
            ...
            <FlatList
                data={['Poluição dos oceanos', 'Condições dos recifes de coral', 'Empoderamento das comunidades costeiras']}
                    ...
                    return (
                        <View className='w-full flex-row mb-6 px-5'>
                            <View className="p-4 gap-2 bg-primary/50 justify-center items-center mx-2 rounded-lg">
                                <ImageBackground source={image} resizeMode="cover" className="h-28 w-24 p-6 justify-end items-end mx-2 bg-black opacity-80">
                            ...
                            <View className='flex-1 justify-center'>
                                <Text className='font-bold text-lg w-[20ch]'>{item}</Text>
                                <View className='flex-row justify-between'>
                                    <View className='gap-4'>
                                        ...
                                        <View className='flex-row' >
                                            <Image source={require('@/assets/seaweed.png')} className='size-4' />
                                            <Image source={require('@/assets/seaweed.png')} className='size-4' />
                                            <Image source={require('@/assets/seaweed-black.png')} className='size-4' />
                                            <Image source={require('@/assets/seaweed-black.png')} className='size-4' />
                                            <Image source={require('@/assets/seaweed-black.png')} className='size-4' />
                                        </View>
                                    </View>
